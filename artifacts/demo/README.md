...
- A presentation/deck in pdf or pptx format -- > Technology Architecture.pdf explains about tech Stack , Achievemnets , solution, output and challenges.
...
- test -> folder having all test data (.eml file)